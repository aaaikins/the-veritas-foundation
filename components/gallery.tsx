...
const galleryImages = [
  // Featured images that actually exist
  { src: "/gallery/caltech-scholar.png", alt: "Veritas Foundation scholar at Caltech", category: "scholars", className: "col-span-2 row-span-2" },
  ...
  { src: "/hero-image.jpg", alt: "Veritas Foundation group photo", category: "events", className: "col-span-2" },
  { src: "/placeholder.svg", alt: "Scholar graduation ceremony", category: "events", className: "" },
  { src: "/placeholder.svg", alt: "Community outreach program", category: "outreach", className: "" },
  { src: "/placeholder.svg", alt: "Mentorship session", category: "mentorship", className: "" }
]
